...
const Admin = () => {
    ...
    const menus = [
        ...
        { name: "Add Post", link: "/ImageUpload", icon:  MdAddAPhoto   },
        { name: "Add Content", link: "/", icon: MdOutlinePostAdd },
    ...
    return (
        <>
            ...
            <div className="min-h-screen  bg-gray-50/50">
                ...
                <div
                    className={`bg-[#0e0e0e] absolute z-20 min-h-screen ${open ? "w-72" : "w-16"
