...
export default function Footer() {
	return (
		...
		<div className='footer w-full   max-sm:-mt-20 lg:w-[100%] max-sm:flex max-sm:flex-col mt-10 max-sm:items-center relative py-4 mx-auto max-sm:w-full '>
		  ...
		  <div className="mx-auto w-full max-w-screen-xl px-6 py-6 lg:py-8">
			<div className="md:flex gap-28 justify-between">
			  <div className="mb-6 md:mb-0 -mt-7">
				<img className='h-[32vh] max-sm:h-[28vh] max-w-full  max-sm:-mt-16 max-sm:-ml-2' src="https://t3.ftcdn.net/jpg/05/99/32/84/360_F_599328438_8IOBA7eB2DfIVXwFZRPcKmJrHCv7yFlJ.jpg" alt="" />
			  </div>
		...
		// <footer class="bg-slate-200 overflow-x-hidden">
		// 	<div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8 relative">
		// 		<div class="grid grid-cols-1 gap-8 lg:grid-cols-3 w-full">
		...
		// 				<p class="mt-4 text-sm text-gray-600 max-w-[35vw] sm:max-w-full">
		...
		// 				</div>
		// 			</div>
		// 			<div class="grid grid-cols-1 lg:col-span-2 gap-10 sm:grid-cols-2 lg:grid-cols-3">
		// 				<div>
		...
		// 			</div>
		// 		</div>
		// 		<div class="copyrightdiv h-11 flex items-center justify-center w-full text-black font-bold absolute bottom-0 left-0">
		// 			<span class="text-sm">
		// 				Copyright © 2024 babashivbrahmi, Powered by babashivbrahmi. All Rights Reserved.
		// 			</span>
		// 		</div>
		// 	</div>
		// </footer>
